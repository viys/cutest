...
> 本仓库基于原作者 Asim Jalis 的 CuTest 项目整理而来，并保留原项目的版权与许可证信息。
>
...
```Bash
# 生成 HTML 测试覆盖率报告（需要 Python gcovr）
python -m pip install gcovr
./test.ps1 coverage
# 报告位置：build/test/coverage-report/coverage.html

# 需要查看 CMake、CTest 和 gcovr 的完整输出时：
./test.ps1 coverage -CoverageVerbose
```
