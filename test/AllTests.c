...
extern void TestCuMemoryAllocFreeAccounting(CuTest*);
extern void TestCuMemoryCallocZeroAndOverflow(CuTest*);
extern void TestCuMemoryReallocNullZeroAndData(CuTest*);
extern void TestCuMemoryCoalescesAdjacentBlocks(CuTest*);
extern void TestCuMemoryOutOfMemoryAndReallocFailure(CuTest*);
extern void TestCuMemoryMinimumEverFreeSize(CuTest*);
extern void TestCuMemoryResetReinitializesHeap(CuTest*);
extern void TestCuMemoryMacroRouting(CuTest*);
...
void RunAllTests(void) {
    ...
    SUITE_ADD_TEST(suite, TestCuMemoryAllocFreeAccounting);
    SUITE_ADD_TEST(suite, TestCuMemoryCallocZeroAndOverflow);
    SUITE_ADD_TEST(suite, TestCuMemoryReallocNullZeroAndData);
    SUITE_ADD_TEST(suite, TestCuMemoryCoalescesAdjacentBlocks);
    SUITE_ADD_TEST(suite, TestCuMemoryOutOfMemoryAndReallocFailure);
    SUITE_ADD_TEST(suite, TestCuMemoryMinimumEverFreeSize);
    SUITE_ADD_TEST(suite, TestCuMemoryResetReinitializesHeap);
    SUITE_ADD_TEST(suite, TestCuMemoryMacroRouting);
